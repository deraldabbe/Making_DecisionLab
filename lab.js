...
if (amysBirthYear === brittanisBirthYear){
  console.log(`They are the smae age.`)
} else {
...
if (temperature <= 80 && rain === true){
  ...
  console.log(`Wear a jacekt and take an umbrella`)
}

if (temperature <= 60 < 80 && rain === true){
  console.log(`One should wear a rainjacket`)
} else {
...
if (temperature <= 60){
  ...
  console.log(`You should wear a light shirt.`)
